...
public class HomePage extends TicketPageObject {
    ...
    @FindBy(xpath = "//*[@id=\"isStudentDan\"]")
    public WebElement isStudentDan;

    @FindBy(xpath = "//*[@id=\"isHighDan\"]")
    public WebElement isHighDan;
    ...
    public void search(TicketInfo ticket) {
        ...
        if( ticket.getIsStudentDan()){
            isStudentDan.click();
        }
        if( ticket.getIsHighDan()){
            isHighDan.click();
        }
        search.click();
